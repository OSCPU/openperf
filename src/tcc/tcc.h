...
// #if defined _WIN32 == defined TCC_TARGET_PE && defined __APPLE__ == defined
// TCC_TARGET_MACHO # if defined __i386__ && defined TCC_TARGET_I386 #  define
// TCC_IS_NATIVE # elif defined __x86_64__ && defined TCC_TARGET_X86_64 # define
// TCC_IS_NATIVE # elif defined __arm__ && defined TCC_TARGET_ARM #  define
// TCC_IS_NATIVE # elif defined __aarch64__ && defined TCC_TARGET_ARM64 # define
// TCC_IS_NATIVE # elif defined __riscv && defined __LP64__ && defined
// TCC_TARGET_RISCV64 #  define TCC_IS_NATIVE # elif defined __riscv && defined
// TCC_TARGET_RISCV32 #  define TCC_IS_NATIVE # endif #endif
...
// ST_FUNC void tcc_debug_extern_sym(TCCState *s1, Sym *sym, int sh_num, int
// sym_bind, int sym_type); ST_FUNC void tcc_debug_typedef(TCCState *s1, Sym
// *sym);
