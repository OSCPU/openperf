...
// 	    dwarf_strp(dwarf_info_section, get_tok_str(sym->v & ~SYM_FIELD,
// NULL)); 	    dwarf_uleb128(dwarf_info_section, dwarf_line.cur_file);
// 	    dwarf_uleb128(dwarf_info_section, file->line_num);
// 	    tcc_debug_check_anon(s1, sym, dwarf_info_section->data_offset);
// 	    dwarf_data4(dwarf_info_section, debug_type - dwarf_info.start);
// 	}
...
// 	    // getcwd (wd, sizeof(wd));
//         wd[0] = '/'; wd[1] = '\0';
// 	    tcov_data.last_file_name = tcov_section->data_offset + strlen(wd) +
// 1; 	    cstr_printf (&cstr, "%s/%s", wd, file->true_filename);
// 	}
