 ...
 ************************************************************************
 */
void gen_pic_list_from_frame_list(PictureStructure currStructure, FrameStore **fs_list, int list_idx, StorablePicture **list, signed char *list_size, int long_term)
{
  int top_idx = 0;
  int bot_idx = 0;
 ...
 ************************************************************************
 */
static void gen_pic_list_from_frame_interview_list(PictureStructure currStrcture, FrameStore **fs_list, int list_idx, StorablePicture **list, signed char *list_size)
{
  int i;
...
#endif
  // set max size
  currSlice->listXsize[0] = (signed char) imin (currSlice->listXsize[0], currSlice->num_ref_idx_active[LIST_0]);
  currSlice->listXsize[1] = (signed char) imin (currSlice->listXsize[1], currSlice->num_ref_idx_active[LIST_1]);
...
void reorder_ref_pic_list(Slice *currSlice, int cur_list)
{
  ...
  // that's a definition
  currSlice->listXsize[cur_list] = (signed char) (num_ref_idx_lX_active_minus1 + 1);
}
