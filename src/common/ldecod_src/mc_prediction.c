...
static inline void set_direct_references(const PixelPos *mb, signed char *l0_rFrame, signed char *l1_rFrame, PicMotionParams **mv_info)
{
  if (mb->available)
  {
...
static void set_direct_references_mb_field(const PixelPos *mb, signed char *l0_rFrame, signed char *l1_rFrame, PicMotionParams **mv_info, Macroblock *mb_data)
{
  if (mb->available)
  {
    signed char *ref_idx = mv_info[mb->pos_y][mb->pos_x].ref_idx;
...
static void set_direct_references_mb_frame(const PixelPos *mb, signed char *l0_rFrame, signed char *l1_rFrame, PicMotionParams **mv_info, Macroblock *mb_data)
{
  if (mb->available)
  {
    signed char *ref_idx = mv_info[mb->pos_y][mb->pos_x].ref_idx;
...
void prepare_direct_params(Macroblock *currMB, StorablePicture *dec_picture, MotionVector *pmvl0, MotionVector *pmvl1, signed char *l0_rFrame, signed char *l1_rFrame)
{
  Slice *currSlice = currMB->p_Slice;
  ...
  *l0_rFrame = (signed char) imin(imin((unsigned char) l0_refA, (unsigned char) l0_refB), (unsigned char) l0_refC);
  *l1_rFrame = (signed char) imin(imin((unsigned char) l1_refA, (unsigned char) l1_refB), (unsigned char) l1_refC);
