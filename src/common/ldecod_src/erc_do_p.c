...
void init_lists_for_non_reference_loss(DecodedPictureBuffer *p_Dpb, int currSliceType, PictureStructure currPicStructure)
{
  ...
  if (currSliceType == B_SLICE)
  {
    if (currPicStructure == FRAME)
    {
      ...
      p_Vid->ppSliceList[0]->listXsize[0] = p_Vid->ppSliceList[0]->listXsize[1] = (signed char) list0idx;
  ...
  // set max size
  p_Vid->ppSliceList[0]->listXsize[0] = (signed char) imin (p_Vid->ppSliceList[0]->listXsize[0], (int)active_sps->num_ref_frames);
  p_Vid->ppSliceList[0]->listXsize[1] = (signed char) imin (p_Vid->ppSliceList[0]->listXsize[1], (int)active_sps->num_ref_frames);
