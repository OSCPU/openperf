...
static const signed char INIT_FLD_MAP_I[1][8][15][2] = {
    ...
    {{{-6, 93},
     ...
     {{-14, 106},
      ...
      {-5, 58},
      {2, 59}},
     //    { {  -1,  73} , {  -7,  73} , {  -6,  76} , {  -7,  71} , {  -9,  72}
     //    , {  -5,  65} , { -14,  83} , {  -8,  72} , { -10,  75} , {  -5,  64}
     //    , {  -4,  59} , { -13,  79} , {  -9,  69} , {  -8,  66} , {   3,  55}
     //    },
     {CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED,
      CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED,
      CTX_UNUSED, CTX_UNUSED, CTX_UNUSED},
...
static const signed char INIT_FLD_MAP_P[3][8][15][2] = {
    ...
    {{{-13, 106},
     ...
     {{-5, 85},
      ...
      {0, 59},
      {2, 59}},
     //    { {  -4,  60} , {  -3,  49} , {  -2,  50} , {  -4,  49} , {  -5,  48}
     //    , {  -2,  46} , {  -7,  54} , {  -1,  45} , {  -4,  49} , {   4,  39}
     //    , {   0,  42} , {   2,  43} , {   0,  44} , {   5,  32} , {  15,  30}
     //    },
     {CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED,
      CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED,
      CTX_UNUSED, CTX_UNUSED, CTX_UNUSED},
...
static const signed char INIT_FLD_LAST_I[1][8][15][2] = {
    ...
    {{{15, 6},
     ...
     {{21, -10},
      ...
      CTX_UNUSED,
      CTX_UNUSED},
     //    { {  12,  33} , {   5,  38} , {   9,  34} , {  18,  22} , {  19,  22}
     //    , {  23,  19} , {  26,  16} , {  14,  44} , {  40,  14} ,  CTX_UNUSED
     //    ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED
     //    },
     {CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED,
      CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED,
...
static const signed char INIT_FLD_LAST_P[3][8][15][2] = {
    ...
    {{{14, 11},
     ...
     {{21, -13},
      ...
      CTX_UNUSED,
      CTX_UNUSED},
     //    { {  17,  27} , {  23,  13} , {  24,  16} , {  22,  25} , {  23,  27}
     //    , {  23,  32} , {  17,  43} , {  17,  49} , {   2,  70} ,  CTX_UNUSED
     //    ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED
     //    },
     {CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED,
      CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED, CTX_UNUSED,
